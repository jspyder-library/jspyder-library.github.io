...
(function($global$$0$$, $alias$$) {
  ...
  function $_bootstrapDom$$($js$$) {
    ...
    $js_dom$$.fn = {_element:[], get count() {
      ...
      return this;
    }, exportCss:function $$js_dom$$$fn$exportCss$($css$$) {
      $css$$ = $css$$ || {};
      this.getCss($css$$);
      return $css$$;
      ...
      return this;
    }, exportOffsetPosition:function $$js_dom$$$fn$exportOffsetPosition$() {
      var $first$$ = null;
      this.getOffsetPosition(function($v$$) {
        $first$$ || ($first$$ = $v$$);
      });
      return $first$$;
      ...
      return this;
    }, exportAttrs:function $$js_dom$$$fn$exportAttrs$($attrs$$) {
      $attrs$$ = $attrs$$ || {};
      this.getAttrs($attrs$$);
      return $attrs$$;
      ...
      return this;
    }, attachStart:function $$js_dom$$$fn$attachStart$($parent$$, $fn$$) {
      var $children$$ = this;
      $js_dom$$($parent$$).element(0, function($p$$) {
        var $doc$$ = $document$$.createDocumentFragment();
        $children$$.each($js_dom$$.fn._append, $doc$$);
      ...
      return this;
    }, attachEnd:function $$js_dom$$$fn$attachEnd$($parent$$, $fn$$) {
      var $children$$ = this;
      $js_dom$$($parent$$).element(0, function($p$$) {
        var $doc$$ = $document$$.createDocumentFragment();
        $children$$.each($js_dom$$.fn._append, $doc$$);
      ...
      $doc$$.appendChild($c$$);
    }, appendBefore:function $$js_dom$$$fn$appendBefore$($child$$) {
      this.element(0, function() {
        var $doc$$ = $document$$.createDocumentFragment();
        $js_dom$$($child$$).each($js_dom$$.fn._append, $doc$$);
      ...
      return this;
    }, appendAfter:function $$js_dom$$$fn$appendAfter$($child$$) {
      this.element(0, function() {
        var $doc$$ = $document$$.createDocumentFragment();
        $js_dom$$($child$$).each($js_dom$$.fn._append, $doc$$);
        this.parentNode && this.parentNode.insertBefore($doc$$, this.nextSibling);
      ...
      return this;
    }, exportClasses:function $$js_dom$$$fn$exportClasses$($classes$$) {
      $classes$$ = $classes$$ || {};
      ...
      return this;
    }, exportHtml:function $$js_dom$$$fn$exportHtml$() {
      var $html$$ = null;
      ...
      if ("function" === typeof $fn$$) {
        var $t$$ = "undefined" === typeof $document$$.documentElement.textContent ? "innerText" : "textContent";
        this.each(function($element$$) {
          $fn$$.call($element$$, $js$$.alg.string($element$$[$t$$]));
        });
      }
      return this;
    }, exportText:function $$js_dom$$$fn$exportText$() {
      var $text$$ = null;
      ...
      return $self$$.each(function($element$$) {
        var $value$$ = "undefined" !== typeof $element$$.value ? $element$$.value : $element$$.getAttribute("value");
        "LI" === $element$$.tagName && ($value$$ = $element$$.getAttribute("value"));
        "undefined" !== $value$$ && $self$$.use($fn$$, [$value$$]);
      });
      ...
      this.use($fn$$, [$obj$$0$$]);
      return this;
    }, exportProps:function $$js_dom$$$fn$exportProps$($obj$$) {
      $obj$$ = $obj$$ || {};
      this.getProps($obj$$);
      return $obj$$;
...
jspyder.extend.fn("dialog", function() {
  ...
  $js_dialog$$.fn = {_element:null, _buttonDefs:null, _template:'<div class="js-dialog-background"><div class="js-dialog"><div class="js-dialog-header"><span class="title-container"></span><span class="dialog-buttons"><i class="button-close close"></i></span></div><div class="js-dialog-body"><div class="body-container"></div></div><div class="js-dialog-footer"><div class="footer-container"></div></div></div></div>', _height:237.2, _width:498, _buttonFactory:function $$js_dialog$$$fn$_buttonFactory$($html$$2_text$$) {
    $html$$2_text$$ = ["<div>", $html$$2_text$$, "</div>"].join("");
    return $js$$.dom($html$$2_text$$);
...
jspyder.extend.fn("dtype", function() {
  ...
  $js_dtype$$.fn = {"byte":js.alg.use($js_dtype$$, function bootstrap() {
    ...
    return function attachInt8($name$$, $_interface$$3_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$3_value$$ = $_createInterface$$($name$$, "number", "byte", $byte$$, $_interface$$3_value$$, $constant$$, $strict$$);
    ...
    return function attachUInt8($name$$, $_interface$$4_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$4_value$$ = $_createInterface$$($name$$, "number", "unsigned byte", $ubyte$$, $_interface$$4_value$$, $constant$$, $strict$$);
    ...
    return function attachInt16($name$$, $_interface$$5_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$5_value$$ = $_createInterface$$($name$$, "number", "short", $short$$, $_interface$$5_value$$, $constant$$, $strict$$);
      $_createBinding$$($_obj$$, $name$$, $_interface$$5_value$$);
      return this;
    };
  }), ushort:js.alg.use($js_dtype$$, function bootstrap() {
    $js_alg$$.short();
    return function attachUInt16($name$$, $_interface$$6_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$6_value$$ = $_createInterface$$($name$$, "number", "unsigned short", ushort, $_interface$$6_value$$, $constant$$, $strict$$);
    ...
    $js_alg$$.int();
    var $int$$ = $js_alg$$["int"];
    return function attachInt32($name$$, $_interface$$7_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$7_value$$ = $_createInterface$$($name$$, "number", "integer", $int$$, $_interface$$7_value$$, $constant$$, $strict$$);
      $_createBinding$$($_obj$$, $name$$, $_interface$$7_value$$);
      return this;
    };
  }), uint:js.alg.use($js_dtype$$, function bootstrap() {
    $js_alg$$.uint();
    return function attachUInt32($name$$, $_interface$$8_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$8_value$$ = $_createInterface$$($name$$, "number", "unsigned integer", uint, $_interface$$8_value$$, $constant$$, $strict$$);
    ...
    return function attachFloat($name$$, $_interface$$9_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$9_value$$ = $_createInterface$$($name$$, "number", "float", $float$$, $_interface$$9_value$$, $constant$$, $strict$$);
    ...
    return function attachDouble($name$$, $_interface$$10_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$10_value$$ = $_createInterface$$($name$$, "number", "double", $double$$, $_interface$$10_value$$, $constant$$, $strict$$);
      $_createBinding$$($_obj$$, $name$$, $_interface$$10_value$$);
      return this;
    };
    ...
    $js_alg$$.int();
    var $int$$ = $js_alg$$.int;
    return function attachFixed($name$$, $_interface$$11_value$$, $_obj$$8_decimals$$, $strict$$, $constant$$) {
      ...
      $_createBinding$$($_obj$$8_decimals$$, $name$$, $_interface$$11_value$$);
      return this;
    };
    ...
    $js_alg$$.int();
    var $uint$$ = $js_alg$$.int;
    return function attachFixed($name$$, $_interface$$12_value$$, $_obj$$9_decimals$$, $strict$$, $constant$$) {
      var $_fixed$$ = $fixed$$($_obj$$9_decimals$$);
      $_obj$$9_decimals$$ = this.obj;
      $_interface$$12_value$$ = $_createInterface$$($name$$, "number", "fixed", $_fixed$$, $_interface$$12_value$$, $constant$$, $strict$$);
      $_createBinding$$($_obj$$9_decimals$$, $name$$, $_interface$$12_value$$);
      return this;
    };
    ...
    return function attachDouble($name$$, $_interface$$13_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$13_value$$ = $_createInterface$$($name$$, "string", "string", $string$$, $_interface$$13_value$$, $constant$$, $strict$$);
    ...
    return function attachUChar($name$$, $_interface$$14_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$14_value$$ = $_createInterface$$($name$$, null, "uchar", $uchar$$, $_interface$$14_value$$, $constant$$, $strict$$, null, null, $validate$$);
    ...
    return function attachBoolean($name$$, $_interface$$15_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$15_value$$ = $_createInterface$$($name$$, "boolean", "bool", $bool$$, $_interface$$15_value$$, $constant$$, $strict$$);
    ...
    return function attachBit($name$$, $_interface$$16_value$$, $strict$$, $constant$$) {
      var $_obj$$ = this.obj;
      $_interface$$16_value$$ = $_createInterface$$($name$$, "number", "bit", $bit$$, $_interface$$16_value$$, $constant$$, $strict$$, null, null, $test$$);
      $_createBinding$$($_obj$$, $name$$, $_interface$$16_value$$);
      return this;
    };
...
jspyder.extend.fn("form", function() {
  ...
  $js_form$$.fn = {_success:function $$js_form$$$fn$_success$($values$$, $invalid$$) {
    ...
    return this;
  }, exportField:function $$js_form$$$fn$exportField$($data$$50_name$$) {
    return ($data$$50_name$$ = this.exportFieldData($data$$50_name$$)) ? $data$$50_name$$.field : null;
    ...
    var $data$$52_val$$ = this.exportFieldData($name$$), $dval$$ = $data$$52_val$$.config.default, $data$$52_val$$ = $data$$52_val$$.config.value;
    this.setFieldValue($name$$, "undefined" !== typeof $data$$52_val$$ ? $data$$52_val$$ : $dval$$);
    return this;
  ...
  $js_form$$.registerControlFn("input", function() {
    ...
    return function($cfg$$) {
      ...
      $$datepicker$$.filter("input").on("click", function($attrs$$9_dateVal_event$$) {
        $attrs$$9_dateVal_event$$ = {readonly:null};
        $js$$.dom(this).getAttrs($attrs$$9_dateVal_event$$);
        $attrs$$9_dateVal_event$$.readonly || ($attrs$$9_dateVal_event$$ = this.value || $cfg$$.value || $cfg$$.default || new Date, $calStruct$$.clear(), $calStruct$$.input = $js$$.dom(this), $calStruct$$.date.setDate($attrs$$9_dateVal_event$$, $calStruct$$.format), $calStruct$$.load().preventClose(), $js$$.dom(this.parentNode).append($calStruct$$.dom), $calStruct$$.DOCDOM.on("click", function __docClick($event$$) {
          if ($calStruct$$.pause) {
    ...
    function $__submitClickFactory$$($form$$) {
      return function __submitClick($attrs$$11_event$$) {
        $attrs$$11_event$$ = {readonly:null};
        $js$$.dom(this).getAttrs($attrs$$11_event$$);
        $attrs$$11_event$$.readonly || $form$$.submit();
      };
    }
    ...
    function $__resetClickFactory$$($form$$) {
      return function __resetClick($attrs$$12_event$$) {
        $attrs$$12_event$$ = {readonly:null};
        $js$$.dom(this).getAttrs($attrs$$12_event$$);
        $attrs$$12_event$$.readonly || $form$$.reset();
      };
    }
    var $__override$$ = {type:"button", nolabel:!0};
    ...
    return function($cfg$$) {
      ...
      var $form$$ = this;
      $$radio$$.find("input").on("change", function($attrs$$17_event$$) {
        $attrs$$17_event$$ = {readonly:null};
        var $$me$$ = $js$$.dom(this);
        $$me$$.getAttrs($attrs$$17_event$$);
        $attrs$$17_event$$.readonly ? $form$$.setFieldValue($cfgname$$, $form$$.exportFieldValue($cfgname$$)) : $$me$$.getValue(function($v$$) {
          $cfg$$["data-value"] = $v$$;
        });
      });
    ...
    function $exportValue$$($data$$72_values$$) {
      var $keys$$ = [], $key$$;
      $data$$72_values$$ = $data$$72_values$$.config["data-values"] = $data$$72_values$$.config["data-values"] || {};
      for ($key$$ in $data$$72_values$$) {
        $data$$72_values$$[$key$$] && $keys$$.push($key$$.substring(4));
      }
      return $keys$$;
    }
    function $setValue$$($data$$, $values$$) {
    ...
    function $buildFunctions$$($form$$, $autocomplete$$, $config$$) {
      ...
      var $fns$$ = {show:function search($css$$8_value$$) {
        ...
        $css$$8_value$$.length >= $minlen$$ ? ($js$$.alg.arrEach($values$$, $__searchLoop$$, $data$$), $css$$8_value$$ = {width:0}, this.getCss($css$$8_value$$), $found$$.setHtml($data$$.match.join("")).attachEnd(this).setCss($css$$8_value$$).find(".search-item").on("mousedown", $searchClick$$)) : $found$$.remove();
      }, hide:function() {
        $found$$.remove();
      }, getFirst:function() {
      }};
    ...
    function $searchValue$$($config$$, $data$$86_value$$, $searchText$$) {
      ...
      $js$$.alg.arrEach($config$$.values, $__searchValue$$, $data$$86_value$$);
      return $data$$86_value$$.match;
    }
    function $setValue$$($data$$, $value$$) {
    ...
    return function($cfg$$) {
      ...
      $$autocomplete$$.on("focus input", function($attrs$$36_event$$) {
        $attrs$$36_event$$ = {readonly:null};
        $js$$.dom(this).getAttrs($attrs$$36_event$$);
        $attrs$$36_event$$.readonly || $$autocomplete$$.getValue($search$$.show);
      });
      return $$autocomplete$$;
    };
    ...
    function $setValue$$($data$$, $v$$) {
      $v$$ = $js$$.alg.string($v$$, "");
      $data$$.field.filter("input").getAttrs({"data-focus":!1}, function($attrs$$37_c$$) {
...
jspyder.extend.fn("template", function() {
  ...
  $js_template$$.fn = {compile:function $$js_template$$$fn$compile$($name$$121_template$$, $data$$, $fn$$) {
    $name$$121_template$$ = $_templates$$.fetch($name$$121_template$$);
    return this.compileExplicit($name$$121_template$$, $data$$, $fn$$);
